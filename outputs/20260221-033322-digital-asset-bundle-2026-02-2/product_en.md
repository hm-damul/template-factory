...
**product_id:** 20260221-033322-digital-asset-bundle-2026-02-2
...
Time window: 19 days. Monthly budget: $560. Primary coin: USDC (Polygon).
...
- Baseline conversion: 0.8% → 19 paid purchases
- Improved conversion: 1.6% → 38 paid purchases
- Revenue: $1501 → $3002
- Lift: +1501 ($100% relative)
...
- **Symptom:** Invoice created but payment never completes
  ...
  - Fix: Suggest USDC (Polygon), show estimated fee (~$3.7), add retry guidance
