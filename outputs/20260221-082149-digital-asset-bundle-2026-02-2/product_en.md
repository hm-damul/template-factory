...
**product_id:** 20260221-082149-digital-asset-bundle-2026-02-2
...
Time window: 24 days. Monthly budget: $560. Primary coin: USDC (Polygon).
...
- Baseline conversion: 2.1% → 109 paid purchases
- Improved conversion: 3.0% → 156 paid purchases
- Revenue: $3161 → $4524
- Lift: +1363 ($43% relative)
...
- **Symptom:** Invoice created but payment never completes
  ...
  - Fix: Suggest USDC (Polygon), show estimated fee (~$1.2), add retry guidance
