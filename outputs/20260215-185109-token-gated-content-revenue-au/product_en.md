...
Time window: 24 days. Monthly budget: $540. Primary coin: BTC.
...
- Improved conversion: 1.7% → 17 paid purchases
- Revenue: $539.0 → $833.0
- Lift: +294.0 ($55% relative)
...
> Support load is a hidden tax. Keep it below ~2.7% per 100 sales using FAQ + troubleshooting.
