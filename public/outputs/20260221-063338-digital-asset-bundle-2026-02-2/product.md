...
**product_id:** 20260221-063338-digital-asset-bundle-2026-02-2
...
Time window: 24 days. Monthly budget: $340. Primary coin: USDC (Polygon).
...
- Baseline conversion: 0.9% → 46 paid purchases
- Improved conversion: 3.1% → 161 paid purchases
- Revenue: $3634 → $12719
- Lift: +9085 ($250% relative)
...
- **Symptom:** Invoice created but payment never completes
  ...
  - Fix: Suggest USDC (Polygon), show estimated fee (~$3.4), add retry guidance
