  ...
  {% for p in products %}
    <div class=\"card\">
      ...
      <div class=\"muted\">
        ...
        · <a href=\"/{{p.product_id}}/promotions/promo_pack.zip\" target=\"_blank\">promo_pack.zip</a>
        · <a href=\"/{{p.product_id}}/promotions/promo_calendar_30d.csv\" target=\"_blank\">promo_calendar_30d.csv</a>
      </div>
    </div>
  {% endfor %}
</body>
